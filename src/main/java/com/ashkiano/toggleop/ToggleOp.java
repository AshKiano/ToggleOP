...
public class ToggleOp extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        System.out.println("Thank you for using the ToggleOp plugin! If you enjoy using this plugin, please consider making a donation to support the development. You can donate at: https://paypal.me/josefvyskocil");
